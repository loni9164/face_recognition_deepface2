...
from deep_face.detectors import FaceDetector
...
def weight_file_path(weight_file):
	weight_dir = Path(__file__).absolute().parent.parent
	return os.path.join(weight_dir,'model_weights', weight_file)
